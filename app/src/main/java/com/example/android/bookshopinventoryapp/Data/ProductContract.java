...
public final class ProductContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.android.bookshopinventoryapp";

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public static final String PATH_PRODUCT = "bookshopinventory";
    ...
    public static class ProductEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "bookshopinventory";
